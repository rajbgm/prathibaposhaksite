			...
			<div class="container">
					...
					<div class="col-sm-12">
						<table width="60%" height="100" border='1' align="center" class="table">
							...
							<tr>
								...
								<td><input type="text" name="billing_name" value="" required
										class="form-control-donate" /></td>
							</tr>
							<tr>
								<td><b>Phone (*)</b></td>
								<td><input type="text" name="billing_tel" value="" required
										class="form-control-donate" /></td>
							</tr>
							<tr>
								<td><b>Email (*)</b></td>
								<td><input type="text" name="billing_email" value="" class="form-control-donate" /></td>
							</tr>
							<tr>
								<td><b>Amount (*)</b></td>
								<td><input type="text" name="amount"
										value="<?php echo get_amount($donation, $donor_category); ?>" required
										class="form-control-donate" /></td>
							</tr>
							<tr>
								<td><b>Currency (*)</b></td>
							...
							if ($donor_category == 'Indian') {
								echo '<tr>
		        			<td><b>Your PAN (*)</b></td><td><input type="text" name="merchant_param1" value="" required class="form-control-donate" /></td>
		        		</tr>';
							}
							?>
							<tr>
								<td>Address</td>
								<td><input type="text" name="billing_address" value="" class="form-control-donate" />
								</td>
							</tr>
							<tr>
								<td>City</td>
								<td><input type="text" name="billing_city" value="" class="form-control-donate" /></td>
							</tr>
							<tr>
								<td>State</td>
								<td><input type="text" name="billing_state" value="" class="form-control-donate" /></td>
							</tr>
							<tr>
								<td>PIN Code</td>
								<td><input type="text" name="billing_zip" value="" class="form-control-donate" /></td>
							</tr>
							<tr>
								<td>Country</td>
				...
				<div class="row">
					<div class="col-sm-12 text-center">
						...
						<br />
						<input TYPE="submit" value="DONATE" class="btn btn-sm rcfBtn btn-white"></td>
