...
<body>
	...
	<section class="space-ptb bg" style="padding-top: 25px;">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
				...
				<div class="col-sm-12">
					<p>
					We are dedicated to maximizing the efficient allocation of your generous donations. Your contributions are eligible for tax exemption under Section 80G (applicable to Indian taxpayers). RCF has earned the GuideStar India Transparency Key (GSN 10877) and is endorsed by NASSCOM/BigTech (a partner of TechSoup Global).
					</p>
				</div>
			</div>
			<div class="row">
				<div class="col-sm-12 mb-3">
					<p>
					RCF is registered on the Benevity Causes platform, where numerous organizations, including Google, Microsoft, Apple, and Adobe, participate in donation matching for their employees. Please check your workplace giving program to determine if your employer matches your contribution.
					</p>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<form id="donationForm" action="donate_step2.php" name="donate_step1" method="post">
						...
						<div>
							...
							<br />
							<input type="radio" id="dc3" name="donation" value="Sponsor-Students-Internet" />
							<label for="dc3">Internet Data for one year (Rs.3500 or USD 45)</label>
							<br />
							<input type="radio" id="dc4" name="donation" value="sponsor-data" />
							<label for="dc4">Internet Data for 2 years (Rs.7,500 or USD 90)</label>
							<br />
							<input type="radio" id="dc5" name="donation" value="Contribute-to-Teacher-Salary" />
							<label for="dc5">Overall teacher's salary for the entire year (Rs.350000 or USD 4215)</label>
							<br />						
							<input type="radio" id="dc6" name="donation" value="sponsor-data-meal" />
							<label for="dc6">Meal for 20 students on Pratibha Poshak Selection Test Day (Rs. 1,200 or USD 15)</label>
							<br />
							<input type="radio" id="dc7" name="donation" value="sponsor-data-schoolbag" />
							<label for="dc7">A school bag (backpack) for a Pratibha Poshak student (Rs. 350 or USD 5)</label>
							<br />
							<input type="radio" id="dc8" name="donation" value="sponsor-other" />
							<label for="dc8">Other</label>
							<br>
